...
# ============================================================================
# MODEL PERFORMANCE METRICS (from ML training)
# ============================================================================

MODEL_PERFORMANCE = {
    'camp_murray': {'r2': 0.7506, 'mae': 2.29, 'rmse': 3.53},
    'grissom': {'r2': 0.6572, 'mae': 2.91, 'rmse': 3.85},
    'hill_weber': {'r2': 0.7159, 'mae': 2.47, 'rmse': 3.67},
    'jdmt': {'r2': 0.5691, 'mae': 3.57, 'rmse': 4.78},
    'kahului': {'r2': 0.4370, 'mae': 4.79, 'rmse': 5.82},
    'malmstrom': {'r2': 0.7207, 'mae': 2.47, 'rmse': 3.74},
    'march_afb': {'r2': 0.6452, 'mae': 1.98, 'rmse': 2.88},
    'mnang': {'r2': 0.7069, 'mae': 2.72, 'rmse': 4.18},
    'offutt': {'r2': 0.6298, 'mae': 4.03, 'rmse': 5.05},
    'peterson': {'r2': 0.6220, 'mae': 2.74, 'rmse': 4.15},
    'travis': {'r2': 0.7885, 'mae': 1.89, 'rmse': 3.09},
    'usafa': {'r2': 0.5069, 'mae': 3.01, 'rmse': 4.10}
}
